			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<strong class="card-title">Adicionar Serviços</strong>
					</div>
					<div class="card-body">
						...
						@csrf
                            ...
                            <div class="row">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" id="data" class="form-control" name="valor" value="{{$servico->valor}}" onKeyPress="return(moeda(this,'.',',',event))">
                                    </div>
									</div>
									</div>
